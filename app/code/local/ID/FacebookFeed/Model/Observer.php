...
class ID_FacebookFeed_Model_Observer {
  ...
  private function getProducts() {
    ...
    $this->oProducts->addAttributeToSelect(['entity_id','sku','material_value','season_value', 'activity_value','gender_value','product_category','product_category_value','name','manufacturer_value','final_price','short_description','url_path','small_image','color_value','type_id']);
  ...
  public function productCallback($args) {
    ...
    $aData['gender'] = @mb_substr($oProduct->gender_value,0,99,'UTF-8');
